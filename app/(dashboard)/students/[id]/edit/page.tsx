  ...
  async function onSubmit(values: StudentFormData) {
    if (!user || !params.id) {
      toast({
        ...
        description: "Você precisa estar logado para editar alunos",
        variant: "destructive",
      });
      return;
    }
                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="font-semibold">Status do Aluno</FormLabel>
                            <Select onValueChange={field.onChange} value={field.value}>
                              <FormControl>
                                <SelectTrigger className="h-11">
          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-lg">
              ...
              <CardContent>
                <div className="space-y-4">
                    ...
                    >
                      {isUploadingAvatar ? (
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          />
                          <p className="mt-2 text-sm text-gray-600">Foto atual</p>
                        </div>
                      ) : (
                        <div className="flex flex-col items-center">
                          <Upload className="h-8 w-8 text-gray-400" />
                          <p className="mt-2 text-sm text-gray-500 text-center">
                            Clique para enviar nova foto<br/>
                  ...
                  {(uploadedAvatarFile || form.watch("avatarUrl")) && (
                    <Button
                      type="button"
                      variant="outline"
                      size="sm"
            ...
            <Card className="shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Como o aluno aparecerá após a atualização
                </CardDescription>
              </CardHeader>
            ...
            <Card className="shadow-lg border-orange-200 dark:border-orange-800">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm">
                    Mudanças no status podem afetar o acesso do aluno à plataforma
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <AlertCircle className="h-4 w-4 text-orange-500 mt-0.5 flex-shrink-0" />
                  <p className="text-sm">
                    Informações de saúde são confidenciais e importantes para a segurança
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <AlertCircle className="h-4 w-4 text-orange-500 mt-0.5 flex-shrink-0" />
